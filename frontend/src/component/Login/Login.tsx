                    ...
                    <form className="flex flex-col">
                        <div className="flex">
                            <div className="flex flex-col gap-6">
                                ...
                                <PrimaryInput placeholder="Username" w="w-[270px] md:w-[500px]" type="text"/>
                                <LockClosedIcon
                                    className="absolute left-4 md:left-5 md:top-[202px] top-[58%] transform -translate-y-1/2 h-5 w-5 md:h-8 md:w-8 text-text-color"/>
                                <PrimaryInput placeholder="Password" w="w-[270px] md:w-[500px]" type="password"/>
                            </div>
                            <button className="md:ml-[50px] ml-[10px] flex-shrink-0 mt-[20px] ml-[50px]"
                        ...
                        <div className="mt-[34px] md:mt-8 flex flex-col md:flex-row md:justify-between md:w-[490px] gap-4">
                            ...
                            >
                                Forgot password ?
                                <span className="absolute bottom-0 left-0 w-0 h-px bg-white transition-all duration-300 hidden md:block group-hover:w-full"></span> </a>
