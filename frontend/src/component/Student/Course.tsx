...
const Course = () => {
  const [selectedCourse, setSelectedCourse] = useState<CourseWithIndex | null>(
    null,
  );
  ...
  const displayCourses: LearningUnitDTO[] = allCourses.filter(
    (course) =>
            ...
            <div className="p-4">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {chapters &&
                    chapters.map(
                      (chapter: LearningUnitChildDto, index: number) => (
                        <CardChapterMobile
                          key={chapter.id}
      ...
      <div className="m-[8px] ml-1 bg-white h-[98vh] w-full md:w-[65vw] rounded-xl flex flex-col p-4 md:p-8">
        {selectedCourse ? (
          <div>
            <div className="flex relative flex-col md:flex-row">
              <div>
                ...
                <div className="mb-6 md:mb-10">
                  <h2 className="text-lg md:text-[20px] text-gray-900 font-bold mb-1">
                    Description
                  </h2>
            ...
            <div>
              <h1 className="text-lg md:text-[20px] text-gray-900 font-bold mb-4">
                Content
              </h1>
  ...
  return (
    <div className="flex w-full md:w-[30%] mb-5">
      ...
      <div className="flex-1">
        <p className="text-base md:text-lg text-gray-900 mb-1 md:mb-2 line-clamp-2">
          {courseName}
        </p>
        <p className="text-xs md:text-sm text-gray-600">
          Exercises: {numberOfExercise}
        </p>
      </div>
    </div>
  );
