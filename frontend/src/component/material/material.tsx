...
export const MyButtonAdvanced = ({
    ...
    const containedColorClasses = {
        primary: 'bg-text-color text-white hover:bg-white hover:text-text-color border-2 border-text-color',
        secondary: 'bg-purple-500 text-white hover:bg-purple-600',
        success: 'bg-green-500 text-white hover:bg-green-600',
        danger: 'bg-red-500 text-white hover:bg-white hover:text-red-500 border-2 border-red-500',
    ...
    const disabledClasses = variant === 'contained'
    ...
    const variantColorClasses = variant === 'contained'
