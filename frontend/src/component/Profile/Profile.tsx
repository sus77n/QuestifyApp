...
const Profile = () => {
    ...
    const profileData = {
        username: "username",
        email: "nn@gmail.com",
        joinedDate: "January 2023", // Example date
        completedCourses: 5, // Example data
        ongoingCourses: 2 // Example data
    };
    ...
    return (
        <div className="h-screen flex ml-1">
            {/* Main content */}
            <div className="m-[8px] bg-white h-[98vh] w-full rounded-xl flex flex-col p-8">
